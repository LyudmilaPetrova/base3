...
<head>
  ...
  <!--[if lt IE 9]>
    <script type="text/javascript" src="framework/core/js/html5.js"></script>
  <![endif]-->
  ...
  <!-- Stylesheets -->
  <link type="text/css" rel="stylesheet" href="getless.php?file=/app/common/css/style.less" media="all" />
  
  
  <!-- Javascript libraries -->
  <script type="text/javascript" src="//ajax.googleapis.com/ajax/libs/jquery/1.8/jquery.min.js"></script>
  <script type="text/javascript">window.jQuery || document.write('<script src="framework/jquery/js/jquery-1.8.min.js"><\/script>')</script>
  
  <script type="text/javascript" src="framework/core/js/browser.js"></script>
  <!--<script type="text/javascript" src="framework/jquery/js/jquery-1.8.min.js"></script>-->
  <!--<script type="text/javascript" src="framework/underscore/js/underscore-1.3.3.js"></script>-->
  <!--<script type="text/javascript" src="framework/debug/js/debug.js"></script>-->
  <!--<script type="text/javascript" src="framework/jquery-placeholder/js/jquery.placeholder.js"></script>-->
  
  
  <!-- Custom javascript -->  
  <script type="text/javascript" src="app/common/js/script.js"></script>
...
<body class="page front one-sidear sidebar-first">  
  <?php 
	$test = 'grid';
	if (isset($_GET['test']))
